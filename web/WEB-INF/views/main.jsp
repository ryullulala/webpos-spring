...
<html>
    ...
    <body>
        <div id="webView">
            ...
            <div>
                <img src="/img/pos_img.png" style="opacity: 0.3;position: absolute;top: 50px;margin-left: 250px; width: 600px;" >
            </div>
            ...
            <div id="login_join">
                <!-- 그냥 div나 span으로? -->
                <a href="" class = "loginJoinBtn" >로그인  |</a>
                <a href="" class = "loginJoinBtn" >회원가입</a>
            </div>
