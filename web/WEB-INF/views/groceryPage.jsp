...
<div id="webView">
    ...
    <div class="button button-pill button-small button-primary" id="deleteBtnLayout"
         style="position: absolute; top: 580px; left: 200px;">
        식자재 삭제
    </div>
    <div class="button button-pill button-small button-primary" id="orderBtnLayout"
         style="position: absolute; top: 580px; left: 800px; ">
        주문
    </div>
</div>
